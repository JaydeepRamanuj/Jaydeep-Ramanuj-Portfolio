...
const SkillChip = ({ skill, level = 3, iconPath }: SkillChipProps) => {
  return (
    <span
      className={`grow flex flex-col items-center justify-center text-center p-1 md:p-4 rounded-xl shadow-md text-white border  hover:scale-105 transition-transform  md:min-w-[100px]         
