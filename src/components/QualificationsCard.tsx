...
function QualificationsCard({
  ...
  return (
    <div className="w-full mt-4 p-2 md:p-4 sm:p-6 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 shadow-lg text-white font-medium flex items-center text-xs sm:text-base text-center gap-4 sm:gap-0 sm:justify-between">
